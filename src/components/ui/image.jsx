...
const FALLBACK_IMAGE_URL =
  "/images/public/12d367_4f26ccd17f8f4e3a8958306ea08c2332~mv2.png"
...
const WIX_MEDIA_HOSTS = ["*", "localhost"]
 ...
 * @property {string} [className] - The class name for the image container.
 * @property {('fill'|'fit'|'contain'|'cover')} [fittingType='fill'] - How the image should fit the container.
 * @property {number} [originWidth] - The original width of the image (for aspect ratio).
 * @property {number} [originHeight] - The original height of the image (for aspect ratio).
 * @property {number} [focalPointX] - The x focal point (0-1) for cropping.
 * @property {number} [focalPointY] - The y focal point (0-1) for cropping.
 * @property {number} [quality=90] - The quality of the image (0-100).
 */

/**
 * Image component that optimizes and serves images via Wix Media Platform or uses a fallback.
 * @typedef {import('react').ComponentType<ImageProps> & { displayName?: string }} ImageComponent
 * @type {ImageComponent}
 */
